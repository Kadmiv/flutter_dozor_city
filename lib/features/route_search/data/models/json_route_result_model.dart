...
class RouteResultSearchDto {
  const RouteResultSearchDto({
  ...
  final AppLatLngDto? realStart;
  final AppLatLngDto? realEnd;
  ...
  final List<AppLatLngDto> previewGeometry;
  final List<RoutePreviewSegment> previewSegments;
  final List<RouteResultStep> routeSteps;
  final bool stored;

  factory RouteResultSearchDto.fromJson(Map<String, dynamic> json) {
    ...
    return RouteResultSearchDto(
      realStartName: json['realStartName'] as String? ?? '',
      realEndName: json['realEndName'] as String? ?? '',
      realStart: json['realStart'] is Map
          ? AppLatLngDto.fromJson((json['realStart'] as Map).cast<String, dynamic>())
          : null,
      realEnd: json['realEnd'] is Map
          ? AppLatLngDto.fromJson((json['realEnd'] as Map).cast<String, dynamic>())
          : null,
      ...
      previewGeometry: lineJson != null
          ? RouteLineDto.fromJson(lineJson).points
          : (directPoints ?? const [])
              .whereType<Map>()
...
typedef JsonRouteResultModel = RouteResultSearchDto;
