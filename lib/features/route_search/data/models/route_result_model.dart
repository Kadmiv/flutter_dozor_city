...
class RouteResultDto {
  ...
  final double? price;
  final AppLatLngDto? realStartPoint;
  final AppLatLngDto? realEndPoint;
  ...
  factory RouteResultDto.fromJson(Map<String, dynamic> json) {
    return RouteResultDto(
      ...
      realStartPoint: json['realStartPoint'] is Map
          ? AppLatLngDto.fromJson((json['realStartPoint'] as Map).cast<String, dynamic>())
          : null,
      realEndPoint: json['realEndPoint'] is Map
          ? AppLatLngDto.fromJson((json['realEndPoint'] as Map).cast<String, dynamic>())
          : null,
...
typedef RouteResultModel = RouteResultDto;
